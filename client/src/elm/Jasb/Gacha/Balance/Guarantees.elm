module Jasb.Gacha.Balance.Guarantees exposing
    ( Guarantees
    , compareGuarantees
    , encodeGuarantees
...
viewGuarantees : Sentiment -> Guarantees -> Html msg
viewGuarantees sentiment (Guarantees guarantees) =
    Html.span
        [ HtmlA.class "guarantees"
        , guaranteeName ++ ". " ++ guaranteeDescription |> HtmlA.title
        ]
        [ guaranteeIcon, Sentiment.viewValue sentiment guarantees ]
