module Jasb.Page.Gacha.Collection.Filters.Model exposing
    ( Filter(..)
    , FilterModel
    , Filters
    , OwnershipFilter(..)
...
import Jasb.Gacha.Quality as Quality exposing (Quality)
import Jasb.Gacha.Rarity as Rarity exposing (Rarity)
