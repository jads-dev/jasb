module Jasb.Page.Gacha.Forge exposing
    ( init
    , load
    , onAuthChange
    , update
...
import Jasb.Editing.Validator as Validator
...
import Jasb.Page.Gacha.Forge.Model exposing (..)
                ...
                , Html.div [ HtmlA.class "tool" ]
                    ...
                    , Html.div [ HtmlA.class "controls" ]
                        [ Html.span
                            ...
                            [ Html.text "Cost: ", Balance.viewRolls Sentiment.PositiveBad cost ]
