module Jasb.Page.Gacha.Collection exposing
    ( init
    , load
    , manageContext
    , onAuthChange
...
import Jasb.Gacha.Balance as Balance
import Jasb.Gacha.Banner as Banner
import Jasb.Gacha.Card as Card
import Jasb.Gacha.Context as Gacha
...
import Jasb.Page.Gacha.Collection.Filters exposing (..)
import Jasb.Page.Gacha.Collection.Filters.Model exposing (..)
import Jasb.Page.Gacha.Collection.Model exposing (..)
import Jasb.Page.Gacha.Collection.Route exposing (..)
import Jasb.Page.Gacha.DetailedCard as Gacha
                        ...
                        Just { banner, card, value } ->
                            let
                                ...
                                viewedValue =
                                    value
                                        |> Api.dataToMaybe
                                        |> Maybe.map (Balance.viewValue Sentiment.PositiveGood)
