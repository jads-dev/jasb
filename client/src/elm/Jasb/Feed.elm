...
import Jasb.Feed.Model exposing (..)
                    ...
                    let
                        winInfo =
                            if winningBets > 0 then
                                let
                                    ...
                                    others =
                                        if otherWinnerCount > 0 then
                                            ...
                                            , totalReturn |> Coins.view Sentiment.PositiveGood
                                            , Html.text " in winnings."
                                            ]

                                        else if (highlighted.winners |> List.length) > 1 then
                                            [ Html.text " A total of ", totalReturn |> Coins.view Sentiment.PositiveGood ]
                                ...
                                , [ Html.text eachWon
                                  , highlighted.amount |> Coins.view Sentiment.PositiveGood
                                  , Html.text "!"
                                  ]
                                , others
                                ]
                ...
                NS { game, bet, spoiler, option, user, message, stake } ->
                    itemRender spoiler
                        ...
                        [ Html.p []
                            ...
                            , stake |> Coins.view Sentiment.Neutral
                            , Html.text " on “"
